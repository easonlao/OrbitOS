...
ASKING_CONSTRAINTS = {
    ...
    "identity_prompt": "先选 1 个最接近你的底色模板；如果都不完全贴切，再补 1 句修正。我会把你的选择整理成初始 identity。",
    "intro": "下面开始 24 题、5 档倾向问卷。它只用于生成 MBTI 种子假设，不是官方 MBTI，也不是最终人格定论。",
    "identity_options": [
        "1. 系统型建设者：喜欢搭框架、定结构、把复杂事收拢清楚",
        "2. 创意探索者：喜欢找方向、试可能性、边做边迭代",
        "3. 务实推进者：更关心落地、效率、把事情真正做完",
        "4. 关系协作者：重视配合、沟通感受、长期合作关系",
        "5. 独立思考者：偏好先自己想清楚，再输出判断",
        "6. 还不确定：先用这项，后面再靠问卷和行为校准",
    ],
    "identity_reply_instruction": "请先回复选项编号；如果需要，再补 1 句修正，例如：1， 但我也很重视长期关系。",
