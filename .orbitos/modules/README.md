...
Thinking-method selection is core behavior, not an optional module. Core runtime behavior stays in `.orbitos/rules/core/`, `.orbitos/workflows/`, `.orbitos/schemas/`, `.orbitos/scripts/`, and `.orbitos/templates/`.
