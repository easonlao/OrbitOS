...
1. 向用户复述本轮要确认的变更对象：
   ...
   - 修正稳定底色描述
2. 按确认类型运行更新脚本：
   - 确认基线：`python .orbitos/scripts/persona/update.py --source 00-系统/09-人物档案.md --runtime . --confirm-baseline`
   - 接受建议：`python .orbitos/scripts/persona/update.py --source ... --runtime . --accept-suggestion <id> --confirmed-statement ... --evidence ...`
   - 否决建议：`python .orbitos/scripts/persona/update.py --source ... --runtime . --dismiss-suggestion <id> --note ...`
   - 修正稳定底色：`python .orbitos/scripts/persona/update.py --source ... --runtime . --identity ...`
