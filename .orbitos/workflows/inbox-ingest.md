...
- 把主题、关联和后续方向投影到 `今日.md` 或 `待确认.md`，不塞进 batch。
- 保持入库动作轻量、可自检、可追溯。
...
- [ ] 已确认每个源文件位于 `01-收件箱/` 根目录。
- [ ] 已移动文件到 `01-收件箱/已入库/`。
- [ ] 已写入 ingest batch。
- [ ] 如有 `needs_review`，已投影到 `今日.md` 或 `待确认.md`。
- [ ] 已执行 Validate Sync。
