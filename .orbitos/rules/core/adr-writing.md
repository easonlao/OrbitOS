...
- OrbitOS 本地设计决策：项目根目录 `../docs/adr/NNNN_short_title.md`。
- 其他项目：优先遵循其本地项目目录或版本控制仓库已有的 ADR 约定；没有约定时使用该项目的 `docs/adr/NNNN_short_title.md`。
...
- OrbitOS 的本地设计 ADR 跟随项目目录维护，不进入 Runtime 机器层。
