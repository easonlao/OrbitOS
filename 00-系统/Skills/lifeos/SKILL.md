...
- Machine copy: `{VAULT}/.orbit/data/lifeos/people.json`
...
- People profile updates must keep `05-资源/人物档案/people.json` and `.orbit/data/lifeos/people.json` consistent.
...
- If old paths contain files, add them to `.orbit/queues/normalization-queue.yaml`.
