...
1. **Check cache**: Look for `05-资源/产品发布/YYYY-MM/YYYY-MM-DD-摘要.md`. If exists with today's date, return cached.
...
7. **Save files**:
   - `05-资源/产品发布/YYYY-MM/YYYY-MM-DD-摘要.md`
   - `05-资源/产品发布/YYYY-MM/原始数据/YYYY-MM-DD_ProductHunt-Raw.md`
   - `05-资源/产品发布/YYYY-MM/原始数据/YYYY-MM-DD_HackerNews-Raw.md`
   - `05-资源/产品发布/YYYY-MM/原始数据/YYYY-MM-DD_GitHub-Raw.md`
