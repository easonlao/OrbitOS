...
2. **Read Yesterday's Daily Note**
   - If exists, read `02-日记/工作日志/[yesterday].md`
...
2. **Populate the daily note:**
   ...
   - **AI 摘要**: Add summary section with top content from newsletters and product launches
     ...
     - Add clear links to full digests in respective folders: `[[05-资源/Newsletters/YYYY-MM-DD-Digest]]` and `[[05-资源/产品发布/YYYY-MM-DD-Digest]]`
...
2. If new, create `01-收件箱/[Brief-Title].md`:
   ```yaml
   ---
   created: YYYY-MM-DD
   status: pending
...
- [标题](原文链接) - [角度]
- [标题](原文链接) - [角度]
→ 完整摘要: [[05-资源/Newsletters/YYYY-MM-DD-Digest|今日Newsletter摘要]]

*产品发布:*
- [产品](原文链接) - [角度] - [指标]
- [产品](原文链接) - [角度] - [指标]
- [产品](原文链接) - [角度] - [指标]
→ 完整摘要: [[05-资源/产品发布/YYYY-MM-DD-Digest|今日产品发布摘要]]
